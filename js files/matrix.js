function matrix() {
    ...
    console.log(deta);
    console.log(a1*b2*c3 + a2*b3*c1 + b1*c2*a3 - a3*b2*c1 - b3*c2*a1 - a2*b1*c3)
...
function matrix1() {
    ...
    a1 = document.getElementById('aa1').value;
    a1 = parseFloat(a1);

    a2 = document.getElementById('aa2').value;
    a2 = parseFloat(a2);

    a3 = document.getElementById('aa3').value;
    a3 = parseFloat(a3);

    b1 = document.getElementById('ba1').value;
    b1 = parseFloat(b1);

    b2 = document.getElementById('ba2').value;
    b2 = parseFloat(b2);

    b3 = document.getElementById('ba3').value;
    b3 = parseFloat(b3);

    c1 = document.getElementById('ca1').value;
    c1 = parseFloat(c1);

    c2 = document.getElementById('ca2').value;
    c2 = parseFloat(c2);

    c3 = document.getElementById('ca3').value;
    c3 = parseFloat(c3);

    q1 = document.getElementById('qa1').value;
    q1 = parseFloat(q1);

    q2 = document.getElementById('qa2').value;
    q2 = parseFloat(q2);

    q3 = document.getElementById('qa3').value;
    q3 = parseFloat(q3);
